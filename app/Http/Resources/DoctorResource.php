...
class DoctorResource extends BaseResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        $this->full = [
            ...
            'reminder_before_consultation' => $this->user?->reminder_before_consultation ?? 10,
            'urgent_reminder_before_consultation' => $this->user?->urgent_reminder_before_consultation ?? 10,
