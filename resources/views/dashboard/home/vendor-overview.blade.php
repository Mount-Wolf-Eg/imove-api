...
@endsection
@section('content')
    <x-breadcrumb title="{{__('messages.overview')}}" pagetitle="{{__('messages.virtual')}}" route="{{route('overview')}}"/>
    <div class="col-xxl-12 col-lg-6 order-first">
        <div class="row row-cols-xxl-4 row-cols-1">
            @php($components = [
                [
                    'title' => __('messages.no_of_referrals'),
                    'count' => $totalConsultations,
                    'icon' => 'bi bi-bookmark-heart-fill',
                    'color' => 'info'
                ],
                [
                    'title' => __('messages.referrals_accepted'),
                    'count' => $totalApprovedConsultations,
                    'icon' => 'bi bi-check-circle-fill',
                    'color' => 'success'
                ],
                [
                    'title' => __('messages.referrals_rejected'),
                    'count' => $totalRejectedConsultations,
