            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-lg-6">
                        ...
                        {!! Form::text('name[en]' , isset($region) ? $region->getTranslation('name', 'en') : '', ['class' => 'form-control']) !!}
                        @error("name.en")
                    ...
                    <div class="col-lg-6">
                        ...
                        <span class="text-danger fw-bold">*</span>
                        {!! Form::text('name[ar]' , isset($region) ? $region->getTranslation('name', 'ar') : '', ['class' => 'form-control']) !!}
                        @error("name.ar")
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
