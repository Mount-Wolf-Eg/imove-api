                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        @if(request()->routeIs('banners.create'))
                            ...
                            <div class="card-body pt-2 pb-3">
                                ...
                                @enderror
                                <br>
                                @if(isset($banner) && $banner->mainImage)
                                    <div class="col-6 position-relative">
                                        <a class="btn btn-flat-light my-3 mx-2 remove-image-resource position-absolute top-0 {{app()->getLocale() == 'ar' ? 'start' : 'end'}}-0" data-id="{{$banner->mainImage->id}}">
                                            <i class="bi bi-x-lg"></i>
                                        </a>
                                        <img src="{{$banner->mainImage->asset_url}}" title="{{$banner->mainImage->name}}" class="img-fluid mt-3" alt="{{__('messages.main_image')}}" style="max-height: 200px">
                                    </div>
                                @endif
                            </div>
                        </div>
