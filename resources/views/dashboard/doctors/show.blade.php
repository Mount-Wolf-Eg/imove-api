    ...
    <div class="col-md-8">
        <div class="card p-2">
            <div class="card-body">
                ...
                <div class="py-2">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-6 col-md-8">
                            ...
                            <span class="px-2 fs-5"><a href="{{route('download', ['dir' => 'doctors', 'file_name' => $attachment->name])}}" class="text-success"><i class="bi bi-download"></i></a></span>
                        </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="py-2">
                    <h5 class="card-title py-2">{{__('messages.wallet')}}</h5>
                    <div class="row pt-2">
                        <div class="col-6">{{__('messages.balance')}}</div>
                        <div class="col-6">{{$doctor->user?->wallet}}</div>
                    </div>
                </div>
            </div>
        </div>
