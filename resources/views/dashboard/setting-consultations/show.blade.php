        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card p-2">
                    <div class="card-body">
                        <div class="row py-2">
                            <div class="col-6">{{__('messages.minimum')}}</div>
                            <div class="col-6">{{$resource->minimum}}</div>
                        </div>
                        <div class="row py-2">
                            <div class="col-6">{{__('messages.maximum')}}</div>
                            <div class="col-6">{{$resource->maximum}}</div>
                        </div>
                        <div class="row py-2">
                            <div class="col-6">{{__('messages.updated')}}</div>
                            <div class="col-6">{{$resource->updated_at?->format('Y-m-d')}}</div>
                        </div>
                    </div>
                </div>
            </div>
