...
return [
    ...
    'average_rating_per_doctor' => 'متوسط التقييم لكل أخصائي',
    'average_number_of_consultations_per_doctor' => 'متوسط عدد الاستشارات لكل أخصائي',
    'average_consultation_duration_per_doctor' => 'متوسط مدة الاستشارة لكل أخصائي',
    'top_performing_doctors' => 'أفضل الاخصائيين أداءً',
    'doctor_name' => 'اسم الأخصائي',
    'session_status' => 'حاله الجلسه',
    'session_type' => 'نوع الجلسه',
    'refer_to_doctor' => 'إحاله إلى أخصائي',
    'rating' => 'التقييم',
    'speciaity' => 'التخصص',
    'no_of_sessions' => 'عدد الجلسات',
    'top_lonsultation_locations' => 'أفضل مواقع الاستشارات',
    'speciality_insights' => 'رؤى التخصصات',
    'most_booked_doctors' => 'الاخصائيين الأكثر حجزًا',
    ...
    'doctor' => 'أخصائي',
    'manage_doctors' => 'إدارة الاخصائيين',
    'doctors' => 'الاخصائيين',
    'doctors_requests' => 'طلبات الاخصائيين',
    'all_doctors' => 'جميع الاخصائيين',
    'add_doctor' => 'إضافة أخصائي جديد',
    'edit_doctor' => 'تعديل الأخصائي',
    'doctor_details' => 'تفاصيل الأخصائي',
    'specialty' => 'تخصص',
    'medical_id' => 'تسجيل مهني',
    ...
    'errors' => [
        'doctor_request_pending' => 'طلب الأخصائي معلقا',
    ...
    'confirm' => [
        'are_you_sure' => 'هل أنت متأكد؟',
        'doctor_approve' => 'هل تريد الموافقة على طلب هذا الأخصائي؟',
        'doctor_reject' => 'هل تريد رفض طلب هذا الأخصائي؟',
    ...
    'models' => [
        ...
        'disease' => 'الأمراض',
        'doctor' => 'الاخصائيين',
        'doctorScheduleDay' => 'يوم عمل الأخصائي',
        'doctorScheduleDayShift' => 'وردية عمل الأخصائي',
        'faq' => 'الأسئلة الشائعة',
    ...
    'sections' => [
        ...
        'welcome_to_message' => 'أخصائيك هو أول منصة للرعاية الصحية عن بعد في المملكة العربية السعودية. يعمل التطبيق على تسهيل العملية بين المرضى والاخصائيين من خلال تقديم استشارات طبية فورية، مما يضمن الوصول إلى الاخصائيين ذوي المهارات العالية والمهنية في مختلف القطاعات الطبية.',
        ...
        'one_click_message' => 'من خلال الربط بين التكنولوجيا المتطورة وفريق متخصص ومعتمد من الاخصائيين، يعمل أخصائيك على تغيير مفهوم الرعاية الصحية في المملكة، مما يسهل تقديم رعاية طبية عالية الجودة للمرضى وأكثر سهولة للأطباء وأكثر وراحة من أي وقت مضى لكلاهما.',
        ...
        'our_doctors_message' => 'الأولوية دائمة تعود لراحة وأمان مستخدمينا من خلال اختيار الاخصائيين الأكثر تأهيلاً وخبرةً. للحفاظ على التزامنا بالتميز، نتبع عملية دقيقة في اختيار أفضل الاخصائيين مثل المؤهل الطبي والتحقق من شهادة الاعتماد والخبرة. بالإضافة الى الاحترافية والمهنية الأخلاقية.',
        'contact_us_title' => 'تواصل معنا',
        'contact_us_message' => 'في أخصائيك، نعطي الأولوية لرضا المستخدمين ونسعى جاهدين لتوفير أفضل تجربة طبية ممكنة. إذا كان لديك أي أسئلة أو استفسارات أو اقتراحات، فنحن هنا لمساعدتك. لا تتردد في التواصل مع فريق الدعم من خلال:',
        'message_us_title' => 'راسلنا باستفسارك',
        'about_us_heading' => 'أخصائيك هو أول منصة للرعاية الصحية عن بعد في المملكة العربية السعودية. يعمل التطبيق على تسهيل العملية بين المرضى والاخصائيين من خلال تقديم استشارات طبية فورية، مما يضمن الوصول إلى الاخصائيين ذوي المهارات العالية والمهنية في مختلف القطاعات الطبية.',
        ...
        'our_mession_message' => 'مهمتنا هي إنشاء نظام للرعاية الصحية يمكن الوصول إليه واستخدامه بكل سهولة، يربط المرضى بالاخصائيين المعتمدين المناسبين لاستشارتهم في مشاكلهم، مما يضمن التشخيص والعلاج والرعاية الوقائية في الوقت المناسب ومن راحة منازلهم.',
    ],
    'offensive' => 'عدواني',
    ...
    'doctor_description' => 'وصف الأخصائي',
    ...
    'doctor_phone' => 'رقم هاتف الأخصائي',
    'doctor_info' => 'بيانات الأخصائي',
    ...
    'gender' => 'الجنس',
    'doctor_notes_recommendations' => 'ملاحظات وتوصيات الأخصائي',
    'medicines' => 'الأدوية',
    'medicine' => 'دواء',
    'quantity' => 'الكمية',
    'dosage' => 'الجرعة',
    ...
    'patient_accepted_doctor_offer' => 'تم قبول عرض الأخصائي',
    'urgent_has_doctors_replies' => 'الحالة الطارئة لديها ردود من الاخصائيين',
    'urgent_patient_approve_doctor_offer' => 'تمت الموافقه علي عرض الأخصائي من قبل المريض',
    'male' => 'ذكر',
    'female' => 'أنثى',
    'home' => 'الرئيسية',
    'about' => 'عنا',
    'aboutUs' => 'من نحن',
    'aboutDoctor' => 'نبذة عن الأخصائي',
    'contact' => 'راسلنا',
    ...
    'notification_messages' => [
        ...
        'consultation' => [
            ...
            'prescription' => [
                'title' => 'روشتة',
                'body' => 'قام الأخصائي بإضافة روشتة لحالتك'
            ],
            ...
            'doctor_cancel' => [
                ...
                'body' => 'تم الغاء الاستشاره من قبل الأخصائي'
            ],
            'patient_cancel' => [
                'title' => 'الغاد الاستشاره',
            ...
            'doctor_referral' => [
                ...
                'body' => 'تم تحويل الاستشاره الي أخصائي اخر'
            ],
    ...
    'not_active_account' => "حسابك قيد المراجعة حاليًا. سيتم إعلامك فور الموافقة عليه.",
    'weight' => 'الوزن',
    'height' => 'الطول',
    'blood_type' => 'نوع الدم',
    ...
    "schedule_slot_not_related_to_doctor" => "الموعد لا ينتمي لهذا الأخصائي",
    "referred_to_another_doctor" => "تم تحويل الاستشارة لأخصائي آخر",
    ...
    "doctor_can_reschedule_validation" => "لا يمكن للأخصائي إعادة جدولة هذا الموعد لأن حالة الاستشارة هي (:status)",
    "needs_reschedule" => "يحتاج إلى إعادة جدولة",
    "no_slots_available" => "لا توجد مواعيد متاحه لدي الأخصائي",
    ...
    'terms_and_conditions_doctor' => 'الشروط و الاحكام الخاصة بالدكتور',
    'terms_and_conditions_patient'  => 'الشروط و الاحكام الخاصة بالمريض',
    'page' => 'الصفحة',
