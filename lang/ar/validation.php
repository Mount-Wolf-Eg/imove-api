...
return [
    ...
    */
    ...
    'password_max'       => 'كلمة المرور يجب ألا تتجاوز 250 حرفًا.',
    'password_confirmed' => 'تأكيد كلمة المرور غير مطابق.',
    'password_regex'     => 'كلمة المرور يجب أن تحتوي على حرف صغير، وحرف كبير، ورقم.',
    ...
    'alpha_dash' => 'يجب أن يحتوي :attribute على أحرف وأرقام وعلامات ناقص وشرطات سفلية فقط.',
    'alpha_num' => 'يجب أن يحتوي :attribute على أحرف وأرقام فقط.',
    'array' => 'يجب أن يكون :attribute مصفوفة.',
    'ascii' => 'يجب أن يحتوي :attribute على أحرف وأرقام ورموز أسكي ذات بايت واحد فقط.',
    ...
    'digits_between' => 'يجب أن يكون :attribute مكونًا بين :min و :max أرقام.',
    'dimensions' => 'الأبعاد لـ :attribute غير صالحة.',
    ...
    'twoNamesRequired' => 'يجب إدخال الاسم الأول والأخير على الأقل.',
    'gt' => [
    ...
    'lowercase' => 'يجب أن يكون :attribute حالة صغيرة.',
    'lt' => [
    ...
    'password' => [
        ...
        'uncompromised' => 'القيمة المعطاة :attribute ظهرت في تسريب بيانات. يرجى اختيار قيمة مختلفة.',
    ],
    ...
    */
    ...
    'custom' => [
        ...
        'contact_type' => [
            'required_if' => 'حقل نوع الاتصال مطلوب عندما يكون النوع عاجلًا.',
        ],
        'doctor_schedule_day_shift_id' => [
            'required_if' => 'حقل معرف تحديد يوم جدول الطبيب مطلوب عندما يكون النوع مع موعد.',
        ],
        'password' => [
            'required'  => 'كلمة المرور مطلوبة.',
            'string'    => 'كلمة المرور يجب أن تكون نصاً.',
            'min'       => 'كلمة المرور يجب أن تحتوي على 6 أحرف على الأقل.',
            'max'       => 'كلمة المرور يجب ألا تتجاوز 250 حرفًا.',
            'confirmed' => 'تأكيد كلمة المرور غير مطابق.',
            'regex'     => 'كلمة المرور يجب أن تحتوي على حرف صغير، وحرف كبير، ورقم.',
        ],
    ],
    'profile_mimes' => 'يجب أن تكون صورة الملف الشخصي فقط من هذه الامتدادات (PNG - JPG - JPEG)',
    'main_image_mimes' => 'يجب أن تكون الصورة الرئيسية فقط من هذه الامتدادات (PNG - JPG - JPEG)',
    'main_video_mimes' => 'يجب أن يكون الفيديو فقط من هذه الامتدادات (MP4,AVI,WEBM)',
    'images_mimes' => 'يجب أن تكون جميع الصور فقط من هذه الامتدادات (PNG - JPG - JPEG)',
    'max_file_size' => 'يجب ان يكون اقصى حجم ',
